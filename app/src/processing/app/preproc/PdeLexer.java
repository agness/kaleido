...
public class PdeLexer extends antlr.CharScanner implements PdeTokenTypes, TokenStream
 {
public PdeLexer(InputStream in) {
...
public PdeLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("color", this), new Integer(156));
	literals.put(new ANTLRHashString("byte", this), new Integer(51));
	literals.put(new ANTLRHashString("public", this), new Integer(62));
	literals.put(new ANTLRHashString("case", this), new Integer(95));
	...
	literals.put(new ANTLRHashString("instanceof", this), new Integer(123));
	...
	literals.put(new ANTLRHashString("assert", this), new Integer(94));
	literals.put(new ANTLRHashString("catch", this), new Integer(99));
	literals.put(new ANTLRHashString("try", this), new Integer(97));
	...
	literals.put(new ANTLRHashString("default", this), new Integer(96));
	...
	literals.put(new ANTLRHashString("finally", this), new Integer(98));
...
tryAgain:
	...
	public final void mWEBCOLOR_LITERAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = WEBCOLOR_LITERAL;
		int _saveIndex;
				...
				case 'X':  case 'x':
				{
					...
					do {
						if ((_tokenSet_2.member(LA(1))) && (true) && (true) && (true)) {
							...
							if ( _cnt316>=1 ) { break _loop316; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
